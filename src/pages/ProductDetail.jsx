            ...
            <div className="row ">
              ...
              <div className="col-lg-7">
                <div className="product-details">
                  ...
                  <div
                    className=" pt-3 pe-5 mb-2"
                    dangerouslySetInnerHTML={{
                      __html: product?.short_description?.name,
                    }}
                  />
                  ...
                  {product?.sale_price > 0 ? (
                    ...
                    <h4 style={{ fontSize: "20px" }} className="pb-4 pt-4">
                      ₹ {product?.normal_price}
                    </h4>
                  )}
                  {currentItem && (
        ...
        <section id="tabs">
          <nav>
            <div className="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <button
                ...
                id="nav-luxury-tab"
                data-bs-toggle="tab"
                data-bs-target="#nav-luxuryyy"
                type="button"
                role="tab"
                aria-controls="nav-luxury"
                aria-selected="true"
              >
                Customer reviews
              </button>
          ...
          <div className="tab-content" id="nav-tabContent">
            ...
            <div
              ...
              id="nav-luxury"
              role="tabpanel"
              aria-labelledby="nav-luxury-tab"
            >
              <div className="container mt-4 mb-4">
                <div className="row">
